...
class Win(PygameGame):
	...
	def redrawAll(self,screen):
		...
		pygame.draw.rect(self.screen,(204,204,255),(140,240,430,70))
		pygame.draw.rect(self.screen,(204,204,255),(240,340,230,70))

		self.message = self.buttonFont.render("You Win!",True,(102,0,204))
		self.congrat = self.buttonFont.render("Congratulations!",True,(102,0,204))
		self.screen.blit(self.congrat,(150,250))
		self.screen.blit(self.message,(250,350))
